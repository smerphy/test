...
Sub-commands:
    ...
    ephorate eval     --policy bundle.yaml --input input.json
    ephorate validate --policy bundle.yaml
    ephorate list-bundles
...
from ephorate_engine.bundles import list_bundles
from ephorate_engine.evaluator import Evaluator, Policy
from ephorate_engine.parser import PolicyParseError, parse_bundle_file
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="ephorate",
        description="Ephorate policy engine CLI",
    )
