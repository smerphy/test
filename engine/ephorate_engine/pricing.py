...
`EPHORATE_CLAUDE_PRICE_BOOK_JSON`, e.g.

    EPHORATE_CLAUDE_PRICE_BOOK_JSON='{"claude-opus-4-8": {"input": 12, "output": 60}}'
...
def _price_book() -> dict[str, ModelPricing]:
    override = os.environ.get("EPHORATE_CLAUDE_PRICE_BOOK_JSON")
    if not override:
