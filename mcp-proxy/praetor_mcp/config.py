"""Proxy configuration (praetor-mcp.yaml) and PraetorClient construction."""
...
def build_client(config: ProxyConfig) -> PraetorClient:
    """Construct the PraetorClient the gate drives (engine + audit + shipping +
