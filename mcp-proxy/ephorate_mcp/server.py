...
``pip install ephorate-mcp[runtime]``.
...
from ephorate_mcp.config import ProxyConfig, UpstreamConfig, build_client
from ephorate_mcp.gate import NAMESPACE_SEP, PolicyGate
from ephorate_mcp.identity import Identity, current_identity
...
class ProxyServer:
    ...
    def _redact_output(self, content: list[Any]) -> list[Any]:
        ...
        from ephorate_engine.redaction import redact_text
    ...
    def build_server(self) -> Any:
        ...
        server: Server = Server("ephorate-mcp")
