...
import httpx
from ephorate_engine import __version__ as _ENGINE_VERSION
...
from ephorate.approval import ApprovalHandler, ControlPlaneApprovalHandler
from ephorate.audit import AuditSink, JsonlAuditSink, NullAuditSink, RemoteShipper
from ephorate.errors import PolicyDenied
from ephorate.quarantine import QuarantineGuard
from ephorate.transport import HttpTransport, ephorate_headers


class EphorateClient:
    ...
    def __init__(
        ...
        *,
        ...
        if control_plane_url is not None:
            ...
            self._heartbeat_headers = ephorate_headers(api_key, org_slug)
